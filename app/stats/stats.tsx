  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <b>{toTimeString(flightTime)}</b> hours.
      </p>
      <p>
        During that time I covered (At least) <b>{tripDistanceCovered} NM</b>,
        which is enough to go around the equator <b>{tripsAroundTheWorld}</b>{" "}
        times.
      </p>
      <p>
        ...
        being the <b>{mostFrequentType}</b>.
      </p>
      <p>
      ...
      <p>
        ...
        taking me <b>{toTimeString(longestFlightTime)}</b> hours to complete. My
