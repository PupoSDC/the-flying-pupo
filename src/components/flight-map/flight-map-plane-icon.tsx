...
import { default as planeIcon } from "./flight-map-plane-icon.png";
...
export type FlightMapPlaneIconProps = {
  /** Track the plane will follow on the map */
  track: Array<{ 
    lat: number, 
    lng: number, 
    altitude: number, 
 ...
 */
export const FlightMapPlaneIcon = memo<FlightMapPlaneIconProps>(
